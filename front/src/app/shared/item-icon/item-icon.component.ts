...
export class ItemIconComponent implements OnInit , OnChanges  {
  ...
  readonly iconBasePath = 'assets/drawable/ui/icons/';
  ...
  get backgroundImage(): string {
    return this.iconBasePath + 'backgrounds/icon_rarity_common.png';
  }

  get itemIcon(): string {
    
    return `${this.iconBasePath}${this.item?.imageUrl || 'icon_empty.png'}`;
  }
  
  get frameIcon(): string {
    return this.iconBasePath + 'frames/icon_frame_1.png';
  }
